...
const floors = [
    ...
    { level: "2F", name: "潮玩空间", desc: "二次元专属聚集地。谷子店、IP店、手办店、妆造间——给同好一个家。用小众文化聚人气，全龄配套留客源，做城市独一无二的次元文化地标。让非主流文化作为突破口形成独属于唐山次元文化潮流的专属区域，以更开阔和包容的姿态接纳多元文化的聚集。实现青年客群与家庭客群的双重覆盖。", brands: ["飞享俱乐部","射手部落","谷子店","WeSpeace腾讯官方店"] },
